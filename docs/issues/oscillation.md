...
| S3 | Preemption ping-pong (refresh bumps seqno → order flips) | mitigation-known | immutable `(prio,ZID)` order; `setup ≤ holding`; min holding time; soft-preempt (MBB) | RFC 5712; H3C; US 9667559 |
